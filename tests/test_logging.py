...
from src.logging_config.audit import AuditLogger
from src.logging_config.config import LoggingConfig, configure_logging
from src.logging_config.performance import PerformanceLogger
...
class TestPerformanceLogger:
    ...
    def test_log_operation(self, mock_get_logger):
        ...
        logger.log_operation(
            operation="database_query", duration=0.5, org_id="org123", team_id="team456"
        )
    ...
    def test_log_slow_operation(self, mock_get_logger):
        ...
        logger.log_operation(
            operation="database_query", duration=0.5, org_id="org123"  # > 0.1 threshold
        )
