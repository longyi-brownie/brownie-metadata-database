...
def upgrade() -> None:
    ...
    op.create_table('incidents',
        ...
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('status', sa.Enum('OPEN', 'IN_PROGRESS', 'RESOLVED', 'CLOSED', 'CANCELLED', name='incidentstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_incidents_idempotency_key'), 'incidents', ['idempotency_key'], unique=False)
    ...
    op.create_table('agent_configs',
        ...
        sa.Column('name', sa.String(length=255), nullable=False),
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('agent_type', sa.Enum('INCIDENT_RESPONSE', 'MONITORING', 'ANALYSIS', 'NOTIFICATION', 'CUSTOM', name='agenttype'), nullable=False),
        sa.Column('is_active', sa.Boolean(), nullable=False),
        sa.Column('config_yaml', sa.Text(), nullable=True),
        sa.Column('config_json', sa.JSON(), nullable=True),
        sa.Column('config_version', sa.String(length=50), nullable=True),
    ...
    op.create_index(op.f('ix_agent_configs_team_id'), 'agent_configs', ['team_id'], unique=False)
    ...
    op.create_index(op.f('ix_stats_metric_name'), 'stats', ['metric_name'], unique=False)
    ...
    op.create_index(op.f('ix_stats_organization_id'), 'stats', ['organization_id'], unique=False)
    ...
    op.create_table('configs',
        ...
        sa.Column('name', sa.String(length=255), nullable=False),
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('config_type', sa.Enum('ORGANIZATION', 'TEAM', 'ALERT', 'AGENT', 'GLOBAL', name='configtype'), nullable=False),
        sa.Column('status', sa.Enum('DRAFT', 'ACTIVE', 'DEPRECATED', 'ARCHIVED', name='configstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_configs_organization_id'), 'configs', ['organization_id'], unique=False)
    ...
    op.create_index(op.f('ix_configs_is_active'), 'configs', ['is_active'], unique=False)
