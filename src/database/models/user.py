...
from ..base import BaseModel, TimestampMixin, OrgScopedMixin, AuditMixin, SoftDeleteMixin
...
class User(BaseModel, TimestampMixin, OrgScopedMixin, AuditMixin, SoftDeleteMixin):
    ...
    # Auth
    password_hash: Mapped[str] = mapped_column(String(255), nullable=True)  # For password auth
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    is_verified: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    
    # OIDC/SSO
    oidc_subject: Mapped[str] = mapped_column(String(255), nullable=True, unique=True, index=True)
