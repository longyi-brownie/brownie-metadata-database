...
from ..base import BaseModel, TimestampMixin, OrgScopedMixin, AuditMixin, VersionMixin, IdempotencyMixin
...
class Incident(BaseModel, TimestampMixin, OrgScopedMixin, AuditMixin, VersionMixin, IdempotencyMixin):
    ...
    priority: Mapped[IncidentPriority] = mapped_column(Enum(IncidentPriority), default=IncidentPriority.MEDIUM, nullable=False)
